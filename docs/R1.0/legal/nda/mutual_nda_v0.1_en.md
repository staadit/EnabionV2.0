# Enabion Mutual Non‑Disclosure Agreement (Mutual NDA)
**Version:** enabion_mutual_nda_v0.1_en  
**Status:** Draft template for MVP pilot (legal review required)  
...
> **Important notice (non‑legal):** This Agreement is provided as a starting template for the Enabion MVP. It must be reviewed and approved by qualified legal counsel before production use.
