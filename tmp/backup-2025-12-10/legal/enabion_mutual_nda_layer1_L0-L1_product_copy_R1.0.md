...
From the Playbook, confidentiality levels are defined as:fileciteturn0file0
...
From the Playbook, Enabion introduces **four NDA layers** to balance speed and confidentiality:fileciteturn0file0
...
5. **Governance:** the NDA does **not** change ownership of data. It is consistent with the „Your Data, Your Control - Our Trust Layer" principle.fileciteturn0file0
...
- remain consistent with **Data Models 1-3** (Standard / Shielded / Sovereign),fileciteturn0file0
...
- Implement the fields and events from section **4** in:
  ...
  - event model (`NDA_LAYER1_*`, `ENGAGEMENT_NDA_BOUND`, etc.).fileciteturn0file1
